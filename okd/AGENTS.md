...
- Versioned OKD documentation links (4.19, 4.20, 4.21, latest)
- Documentation structure across all versions
- Quick links to installation, networking, storage, edge/telco, operators
- Current target: OKD 4.19 / CentOS Stream CoreOS (SCOS)

**Quick links for current target (4.19):**
- Installation overview: https://docs.okd.io/4.19/installing/overview/index.html
- Bare metal IPI: https://docs.okd.io/4.19/installing/installing_bare_metal_ipi/ipi-install-overview.html
- SNO (Single-Node): https://docs.okd.io/4.19/installing/installing_sno/install-sno-installing-sno.html
- Edge computing: https://docs.okd.io/4.19/edge_computing/index.html
- SR-IOV: https://docs.okd.io/4.19/networking/hardware_networks/about-sriov.html
